...
import (
	...
	newtender "gitlab.com/Satori27/avito/internal/http-server/handlers/tender/new"
	...
	"gitlab.com/Satori27/avito/internal/lib/converter"
	"gitlab.com/Satori27/avito/internal/storage/postgres/models"
	"gorm.io/gorm"
)
...
func (s *Storage) SaveTender(req newtender.Request) (newtender.Response, error) {
	...
	newTenderVersion := models.TenderVesion{TenderID: newTender.ID, Name: newTender.Name, Description: newTender.Description, ServiceType: newTender.ServiceType, Status: newTender.Status, EmployeeUsername: newTender.EmployeeUsername, OrganizationID: newTender.OrganizationID}
	...
	return newtender.Response{
		...
		CreatedAt:   converter.Time(newTender.CreatedAt),
		Name:        newTender.Name,
...
func (s *Storage) StatusPut(req puttenderstatus.Request) (puttenderstatus.Response, error) {
	...
	return puttenderstatus.Response{
		...
		CreatedAt:   converter.Time(tender.CreatedAt),
		Name:        tender.Name,
...
func (s *Storage) GetTenders(req gettenders.Request) (gettenders.ResponseList, error) {
	...
	for _, el := range tenders {
		res := gettenders.Response{
			ID:          el.ID,
			Version:     el.Version,
			CreatedAt:   converter.Time(el.CreatedAt),
			Name:        el.Name,
...
func (s *Storage) TenderRollback(req tendersrollback.Request) (tendersrollback.Response, error) {
	...
	var tenderVersion models.TenderVesion

	query := s.db.Model(&models.TenderVesion{})
...
func (s *Storage) UpdateTenderByVersion(tender *models.Tender, newTender *models.TenderVesion) {
...
func (s *Storage) UpdateTender(tender *models.Tender) error {
	...
	if err := s.db.Create(&models.TenderVesion{
		TenderID: tender.ID,
		Version:  tender.Version,
